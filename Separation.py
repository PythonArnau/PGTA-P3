...
class SeparationSample:
    ...
    def __init__(self):
        ...
        self.leader_x: float = 0.0
        self.leader_y: float = 0.0
...
def calculate_separation(leader_fp: FlightPlan, follower_fp: FlightPlan, leader_flight: Flight, follower_flight: Flight, tower06, tower24):
    ...
    #leader_lats = [rec.lat for rec in leader_recs]
    #leader_lons = [rec.lon for rec in leader_recs]
    ...
    for f_rec in follower_recs:
        ...
        #inter_lat_leader = np.interp(t, leader_times, leader_lats)
        #inter_lon_leader = np.interp(t, leader_times, leader_lons)
        ...
        sample.leader_x = float(inter_x)
        sample.leader_y = float(inter_y)
