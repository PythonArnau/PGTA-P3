...
from Flights import FlightRecord, Flight, load_csv, load_csv2, Generate_Flights, AddCoords, Flights_with_deadreckoning3, filter_records_from_departure, Flights_with_deadreckoning2, howManyAC, unify_csv
...
filePaths = ["P3_00h_04h.csv", "P3_04h_08h.csv", "P3_08h_12h.csv", "P3_12h_16h.csv", "P3_16h_20h.csv", "P3_20h_00h.csv"]
file = unify_csv(filePaths)
records = load_csv2(file)
...
AddAsterixCSV(file, stereographCoord)
...
Flights_interp = Flights_with_deadreckoning3(Flights)
...
filter_records_from_departure(filtered_flights)
